                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-block">
                                                            <form method="POST" action="<?php echo base_url(); ?>dashboard/prosesTambahGaleri" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <textarea rows="5" cols="5" name="keterangan" class="form-control"
