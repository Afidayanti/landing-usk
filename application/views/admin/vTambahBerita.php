                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-block">
                                                            <form method="POST" action="<?php echo base_url(); ?>dashboard/prosesTambahBerita" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-10">
                                                                                    <textarea rows="5" cols="5" name="berita" class="form-control"
                                                                                    placeholder="Isi Detail Beritsa"></textarea>
                                                                                </div>
                                                                            </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="kategori" class="form-control">
                                                                                ...
                                                                                <option value="2">UPT Percetakan</option>
                                                                                <option value="3">AAC Dayan Dawood</option>
                                                                                <option value="4">RSP Prince Nayef</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
