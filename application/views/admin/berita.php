                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-header-right"> 
                                                <a  class="btn btn-info" href="<?= base_url(); ?>dashboard/tambahBerita">Tambah</a>    
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($berita as $b) {?>
                                                            ...
                                                            <?php if ($b->kategori_berita == 1) {
                                                                ...
                                                                $kategori="UPT Percetakan";
                                                            }if ($b->kategori_berita == 3) {
                                                                $kategori="AAC Dayan Dawood";
                                                            }if ($b->kategori_berita == 4) {
                                                                $kategori="RSP Prince Nayef";
                                                            }
                                                             ?>
                                                        <tr>
                                                            <!-- <th scope="row">1</th> -->
                                                            <td><?=$b->judul?></td>
                                                            <td><Img style="width: 40px; heigth: 40px" src="<?=base_url()?>foto/<?=$b->foto;?>"></td>
                                                            <td><?=$b->berita?></td>
                                                            <td><?=$kategori?></td>
