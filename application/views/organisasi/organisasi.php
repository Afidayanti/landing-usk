<div class="container">
    <div class="row row-cols-1 row-cols-md-3 mt-5">
      <div class="col mb-4 mb-5 mb-5">
        <div class="cardto">
        <img id="syaiful"  src="<?php echo base_url('assets/img/5.png') ?>" class="card-img-top" alt="lorem ipsum syaiful">
        </div>
          ...
          <span>
            ...
            <a href="#"> &emsp; SEE INFO <img src="<?php echo base_url('assets/img/V4.png ') ?>"></a> 
          </span>
      </div>
      <div class="col mb-4 mb-5">
        <div class="cardto">
          <img id="muslim" src="<?php echo base_url('assets/img/2.png ') ?>" class="card-img-top" alt="lorem ipsum muslim">
        </div>
        ...
        <div class="cardto">
          <img id="juanda" src="<?php echo base_url('assets/img/1.png ') ?>" class="card-img-top" alt="lorem ipsum juanda">
        </div>
      ...
      <div class="col mb-4 mb-5">
        <div class="cardto">
          <img id="yossi" src="<?php echo base_url('assets/img/9.png ') ?>" class="card-img-top" alt="lorem ipsum yossi">
        </div> 
      ...
      <div class="col mb-4 mb-5">
        <div class="cardto">
          <img id="fifi" src="<?php echo base_url('assets/img/4.png ') ?>" class="card-img-top" alt="lorem ipsum fifi">
        </div>
      ...
      <div class="col mb-4 mb-5">
        <div class="cardto">
          <img id="ratna" src="<?php echo base_url('assets/img/3.png ') ?>" class="card-img-top" alt="lorem ipsum ratna">
        </div>
 ...
 <div class="p-5"> <div class="hrto"></div></div>
  <div class="container text-center">
    <h2 class="katato">Koordinator Perencaan Keuangan dan Pelaporan</h2>
      <p class="katao">Hendra Halim, M.E.</p>
      <h2 class="katato">Koordinator Manajemen Aset, Pembiayaan dan Inovasi</h2>
      <p class="katao">Fathurrahman Anwar, SE., MBA</p>
      <h2 class="katato">Koordinator Sumber Daya Manusia</h2>
      <p class="katao">Wida Yulia Viridanda, S.Psi</p>
      <h2 class="katato">Koordinator Bisnis Komersil.</h2>
      <p class="katao">Sayyid Afdhal El Rahimi, S.Kel., M.Si</p>
      <h2 class="katato">Koordinator Bisnis Pelayanan</h2>
      <p class="katao">Dr. drg. Munifah, MARS.</p>
      <h2 class="katato">Koordinator Teknologi dan Inovasi</h2>
      <p class="katao">Yudha Nurdin, ST.,MT</p>
      <h2 class="katato">Koordinator Branding dan Marketing</h2>
      <p class="katao">Dr. Wira Dharma, S.Si., M.P., M.Si</p>
      <h2 class="katato">Koordinator Kerja Sama dan Networking</h2>
      <p class="katao">Dr. Iskandar AS., S.Pd., M.A.</p>
      <h2 class="katato">Koordinator Monitoring dan Evaluasi</h2>
